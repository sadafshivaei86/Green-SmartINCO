          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <section className="bg-white border border-slate-100 rounded-[2.5rem] p-10 shadow-sm space-y-12">
              ...
              <div className="relative pt-16 pb-8">
                ...
                <div className="relative mt-12 mb-8">
                  ...
                  {/* Risk Point Marker - Precise Indicator */}
                  <motion.div 
                  ...
                  >
                    ...
                    {/* Label sitting directly on the extension */}
              ...
              {/* Strategic Insights Cards - Moved inside */}
              ...
              <div className="pt-8 border-t border-slate-100">
                <p className="text-[10px] text-slate-400 leading-relaxed font-medium">
                  Ref: International Chamber of Commerce (ICC). (2020). Incoterms® 2020: The ICC Rules for the Use of Domestic and International Trade Terms. ICC Services. 
                  <br />All risk calculations are based on standard ICC transfer points as defined in the official protocol.
                </p>
              </div>
            </section>

            {/* Sustainability & Carbon Control Toolbar */}
            <section className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-10 shadow-2xl space-y-12 relative overflow-hidden">
              ...
              <div className="space-y-8 relative z-10">
                ...
                {/* Vertical Pin Marker for Sustainability */}
                <motion.div 
                  initial={{ opacity: 0, scale: 0 }}
                  animate={{ opacity: 1, scale: 1, left: `${info.transferPosition}%` }}
                  transition={{ delay: 1.5, type: "spring" }}
                  className="absolute top-0 bottom-0 -ml-0.5 w-1 bg-white/20 z-10"
                >
                  <div className="absolute top-1/2 -translate-y-1/2 -left-1.5 w-4 h-4 bg-white border-2 border-slate-900 rounded-full shadow-lg flex items-center justify-center">
                    <div className="w-1 h-1 bg-slate-900 rounded-full" />
                  </div>
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 px-3 py-1 bg-white text-[9px] font-black text-slate-900 rounded-lg whitespace-nowrap shadow-xl">
                    TRANSFER POINT
              ...
              <div className="p-8 bg-slate-800/50 rounded-3xl border border-slate-700 space-y-6 relative z-10">
                <div className="flex items-center gap-3">
                  <div className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest ${info.buyerCarbonControl > info.sellerCarbonControl ? 'bg-red-500/20 text-red-400' : 'bg-emerald-500/20 text-emerald-400'}`}>
                    {info.buyerCarbonControl > info.sellerCarbonControl ? 'Buyer Carbon Control Dominant' : 'Seller Carbon Control Dominant'}
                  </div>
                </div>
              ...
              {/* Sustainability Insights Cards */}
              <div className="grid sm:grid-cols-2 gap-4 relative z-10">
                {info.sustainabilityInsights.map((insight, i) => (
                  <div 
                    key={i} 
                    className={`p-6 rounded-[2rem] border transition-all hover:scale-[1.02] ${
                      insight.type === 'tip' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' :
                  ...
                  >
                    <div className="flex items-center gap-2 mb-3">
                       <span className="font-black text-[9px] uppercase tracking-[0.2em] opacity-60">{insight.type}</span>
                    </div>
                    <p className="text-xs font-bold leading-relaxed">{insight.text}</p>
                  </div>
                ))}
