                      ...
                      <div className="grid grid-cols-1 gap-8">
                        ...
                        <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm transition-all hover:shadow-md">
                          ...
                          <div className="relative pt-12 pb-6 px-4">
                            ...
                            <div className="flex justify-between mt-12 p-5 bg-slate-50/50 rounded-[1.5rem] border border-slate-100/50">
                              <div className="flex items-center gap-4">
                          ...
                          <div className="relative pt-12 pb-6 px-4">
                            ...
                            <div className="flex justify-between mt-12 p-5 bg-slate-50/50 rounded-[1.5rem] border border-slate-100/50">
                              <div className="flex items-center gap-4">
                                <div className="w-4 h-4 bg-blue-600 rounded-full shadow-md" />
                                <div className="flex flex-col">
                                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Seller Share</span>
                                  <span className="text-xl font-black text-blue-600">{info.detailedAnalysis.costAllocation.sellerPercentage}%</span>
                                </div>
                              </div>
                              <div className="flex items-center gap-4 text-right">
                                <div className="flex flex-col">
                                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Buyer Share</span>
                                  <span className="text-xl font-black text-orange-600">{info.detailedAnalysis.costAllocation.buyerPercentage}%</span>
                                </div>
                                <div className="w-4 h-4 bg-orange-500 rounded-full shadow-md" />
                              </div>
                            </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                             <div className="space-y-6 flex flex-col justify-center">
                                <div className="flex items-center gap-5 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 shadow-sm transition-all hover:border-slate-300">
                                   ...
                                   <div>
                                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-0.5">Insurance Responsible</span>
                                ...
                                <div className="p-6 bg-slate-900 text-white rounded-[2rem] border border-slate-800 shadow-xl space-y-3 relative overflow-hidden">
                                   ...
                                   <div className="pt-2 border-t border-white/10 mt-2">
                                      <p className="text-[9px] text-white/50 font-medium tracking-wide">Standardized ICC (Institute Cargo Clauses) mapping as per 2020 revision.</p>
                                   </div>
                                </div>
                             </div>
                        ...
                        <div className="pt-12 border-t border-slate-100 space-y-8 mt-12">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                             ...
                             <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 space-y-4">
                                <div className="flex justify-between items-center">
                                  <h5 className="font-black text-[10px] uppercase tracking-widest text-slate-900">Customs Duties (A7/B7)</h5>
                                  <Globe size={14} className="text-slate-400" />
                                </div>
                                <div className="grid grid-cols-3 gap-1.5">
                                  {[
                                    { label: 'Export', role: info.detailedAnalysis.customs.export },
                                    { label: 'Transit', role: info.detailedAnalysis.customs.transit },
                                    { label: 'Import', role: info.detailedAnalysis.customs.import }
                                  ].map((item) => (
                                    <div key={item.label} className="bg-white p-2 rounded-xl border border-slate-100 text-center">
                                      <div className="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-0.5">{item.label}</div>
                                      <div className={`text-[9px] font-black ${item.role === 'Seller' ? 'text-blue-600' : 'text-orange-600'}`}>
                                        {item.role}
                                      </div>
                                    </div>
                                  ))}
                                </div>
                                <p className="text-[9px] text-slate-500 font-medium leading-tight">Covers export licenses, security clearances, and import formalities.</p>
                             </div>
                             ...
                             <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 space-y-4">
                                <div className="flex justify-between items-center">
                                  <h5 className="font-black text-[10px] uppercase tracking-widest text-slate-900">Delivery Point (A2)</h5>
                                  <CheckCircle2 size={14} className="text-slate-400" />
                                </div>
                                <div className="space-y-3">
                                  <div>
                                    <div className="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Physical Handoff</div>
                                    <p className="text-[11px] font-bold text-slate-900 leading-tight">{info.detailedAnalysis.delivery.point}</p>
                                  </div>
                                  <div>
                                    <div className="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Notice protocol</div>
                                    <p className="text-[10px] text-slate-600 font-medium leading-tight italic">"{info.detailedAnalysis.delivery.notices}"</p>
                                  </div>
                                </div>
                             </div>
                          </div>
